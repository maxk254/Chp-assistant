      ...
      return (
        <div className="max-w-7xl mx-auto py-8 px-8">
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8">
            <h2 className="text-3xl font-bold text-white mb-6">AI Diagnosis Results</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700">
                <p className="text-slate-400 text-sm mb-2">Diagnosis</p>
                <p className="text-2xl font-bold text-white">{analysisResults.diagnosis}</p>
                <p className="text-emerald-400 text-sm mt-2">Confidence: {analysisResults.confidence}</p>
              </div>

              <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700">
                <p className="text-slate-400 text-sm mb-2">Recommended Medical Facility</p>
                <p className="text-xl font-bold text-teal-400">{analysisResults.recommendedFacility}</p>
                <p className={`text-sm mt-2 ${analysisResults.emergencyLevel === 'HIGH' ? 'text-red-400' : 'text-amber-400'}`}>
            ...
            <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700 mb-8">
              <p className="text-slate-400 text-sm mb-4">Clinical Recommendations</p>
